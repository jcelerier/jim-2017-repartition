...
Les deux principaux mécanismes pour la synchronisation d'horloges physiques sont NTP et PTP. 

Les horloges logiques ont été introduites par Leslie Lamport~\cite{lamport1978time} afin d'offrir des possibilités de vérification sur les systèmes répartis.
...
http://vlsicad.ucsd.edu/courses/ece260b-w07/papers/clock/Friedman.pdf
