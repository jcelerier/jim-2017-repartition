...
Dans la sémantique de i-score, le noeud temporel est l'objet permettant de synchroniser le début et la fin de plusieurs éléments. 
...
De plus, on considère les possibilités d'ordonnancement des évènements lors de la communication entre clients :
