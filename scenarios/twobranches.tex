...
\draw (3.44595, 22.8223) node {$G_1$}; % hits82viva90 
\draw[dashed,line width=1pt] (0, 21.5397)  -- (3.0888, 21.5397) ; % drop40disk64 
\draw (1.5444, 21.7397) node {$G_2$}; % drop40disk64 
...
\draw (4.0444, 20.754) node {$G_2$}; % jack65dais78 
